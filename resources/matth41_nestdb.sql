...
--
-- Host: localhost
-- Generation Time: Mar 01, 2016 at 09:41 PM
...
CREATE TABLE `nest` (
  ...
  `alt_heat` int(11) NOT NULL,
  `aux_threshold` int(11) NOT NULL,
  `hvac_wires` text NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
--
ALTER TABLE `nest`
  ADD UNIQUE KEY `log_datetime` (`log_datetime`);
